...
export const extend = <T extends NonNullable<unknown>, X extends NonNullable<unknown>>(a: T, ext: X) => {
  Object.assign(a, ext)
  return a as T & X
}

export const extendMany = <T extends NonNullable<unknown>, X extends NonNullable<unknown>>(a: T, ext: (a: T) => X) => {
...
export const inputDate = extendMany(
