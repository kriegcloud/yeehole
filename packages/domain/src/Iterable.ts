 ...
 * @example
 * ```ts
 * import { makeBy } from "@ye/domain/Iterable"
 *
 ...
 * @example
 * ```ts
 * import { range } from "@ye/domain/Iterable"
 *
 ...
 * @example
 * ```ts
 * import { replicate } from "@ye/domain/Iterable"
 *
 ...
 * @example
 * ```ts
 * import { fromRecord } from "@ye/domain/Iterable"
 *
 * const x = { a: 1, b: 2, c: 3 }
 ...
 * @example
 * ```ts
 * import { isEmpty } from "@ye/domain/Iterable"
 *
 ...
 * @example
 * ```ts
 * import { Iterable, Option } from "domain"
 *
 * assert.deepStrictEqual(
 ...
 * @example
 * ```ts
 * import { Iterable, Either } from "domain"
 *
 * assert.deepStrictEqual(
